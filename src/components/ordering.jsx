  ...
  return (
    <div className="body">
      <header>
        ...
        <Link to="/support"><button className="support-btn">Contact Support</button></Link>
      </header>
